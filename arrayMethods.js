...
/*const sixteenCentury = inventors.filter((inventor) => {
...
/*const inventorYears = inventors.map((inventorYear)=>{
...
const whoisEdison = inventors.find((inventor) => {
  return inventor.last  === "Edison";
})

console.log(whoisEdison);